...
if __name__ == '__main__':
    ...
    for base, cfg in DATASETS.items():
        ...
        log_path = f"pyxai_results/abd/{base}.{num}.log"
        ...
        for i, (inst, expl) in enumerate(zip(i_list, expl_list)):
            ...
            if expl != "timeout":
                ...
                output_str += f"nof. buggy: {len(expl) - len(real_axp)}\n"
        ...
        open(f"results/pyxai_vs_RFxpl/abd/{base}.{num}.log", 'w').write(output_str)
