...
class BaseRF(object):
    ...
    def save_params(self, params_filename):
        """
        Save the training hyperparameters to JSON.
        """
        # Option A: grab everything from the fitted estimator
        params = self.forest.get_params()

        # Option B: if you only care about the ones you originally set,
        # you could instead reconstruct that dict from your __init__-args,
        # e.g. {'n_trees': ..., 'depth': ...}
        # params = {
